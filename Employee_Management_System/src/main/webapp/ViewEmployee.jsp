...
<body>
	...
	<%
		...
		while(rs.next()){
			...
			out.println("<tr class='table-light'><td>"+id+"</td><td>"+name+"</td><td>"+email+"</td><td>"+phno+"</td><td>"+dob+"</td><td>"+address+"</td><td>"+gender+"</td><td>"+adhaar+"</td><td>"+pan+"</td><td>"+did+"</td><td>"+username+"</td><td>"+pass+"</td></tr>");
